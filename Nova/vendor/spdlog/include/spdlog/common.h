...
#define SPDLOG_LEVEL_FATAL 6
#define SPDLOG_LEVEL_SPECIAL 7
...
#define SPDLOG_LEVEL_NAMES                                                                                                                 \
    {                                                                                                                                      \
        "trace", "debug", "info", "warning", "error", "critical", "fatal", "special", "off"                                                                    \
    }
#endif
static string_view_t level_string_views[] SPDLOG_LEVEL_NAMES;

#if !defined(SPDLOG_SHORT_LEVEL_NAMES)
#define SPDLOG_SHORT_LEVEL_NAMES {"T", "D", "I", "W", "E", "C", "F", "S", "O"}
#endif
