...
template<typename... Args>
inline void spdlog::logger::special(const char *fmt, const Args &... args)
{
    log(level::special, fmt, args...);
}
...
template<typename T>
inline void spdlog::logger::special(const T &msg)
{
    log(level::special, msg);
}
...
template<typename... Args>
inline void spdlog::logger::fatal(const wchar_t *fmt, const Args &... args)
{
    log(level::fatal, fmt, args...);
}
